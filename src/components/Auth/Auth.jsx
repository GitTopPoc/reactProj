...
const AuthForm = (props) => {
    return <form className={style.auth_form} onSubmit={props.handleSubmit}>
        <div className={style.auth_form_input}><Field name={"login"} component={"input"} type={"text"}
                                                      placeholder={"Login"}/></div>
        <div className={style.auth_form_input}><Field name={"password"} component={"input"} type={"password"}
                                                      placeholder={"Password"}/></div>
        <div className={`${style.auth_form_checkbox} ${style.remember_field}`}><Field name={"rememberMe"}
                                                                                      component={"input"}
